...
static ISP_S32 fun_autoscene_sc3335(ISP_DEV IspDev,ISP_EXT_AUTOSCENE_FUN_PARA_S *pstPara, AUTOSCENE_PARA_ADDR_S stAddr)
{
	return ISP_SUCCESS;
}
...
note:
*************************************************************************/
ISP_S32 autoscene_init_sc3335(			ISP_DEV IspDev,
									...
									AUTOSCENE_PARA_ADDR_S stAddr)
{
	...
	// fun
	pstAutoSceneDn->pfun_autoscene_sns = fun_autoscene_sc3335;
