...
static const ISP_U16 gau16DrcLut_imx335[][DRC_IDX_NUM] = {
	//linear
...
static ISP_S32 fun_autoscene_imx335(ISP_DEV IspDev,ISP_EXT_AUTOSCENE_FUN_PARA_S *pstPara, AUTOSCENE_PARA_ADDR_S stAddr)
{
	return ISP_SUCCESS;
}
...
note:
*************************************************************************/
ISP_S32 autoscene_init_imx335(			ISP_DEV IspDev,
									...
									AUTOSCENE_PARA_ADDR_S stAddr)
{
	...
	pstAutoSceneDn->stAePara.au8AeStrategyStrDef[0] = 0x14;
	// fun
	pstAutoSceneDn->pfun_autoscene_sns = fun_autoscene_imx335;
