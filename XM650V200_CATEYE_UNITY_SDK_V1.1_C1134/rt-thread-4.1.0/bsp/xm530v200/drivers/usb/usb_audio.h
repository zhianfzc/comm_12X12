...
#define AUDIO_AC_SELECTOR_UNIT_DESCRIPTOR_INIT(bUintID, ...) \
    0x07,                            /* bLength */                                  \
    AUDIO_INTERFACE_DESCRIPTOR_TYPE, /* bDescriptorType */                          \
    AUDIO_CONTROL_SELECTOR_UNIT,     /* bDescriptorSubtype */                       \
    bUintID,                         /* bUnitID */                                  \
    PP_NARG(__VA_ARGS__),            /* bNrInPins */                                \
    __VA_ARGS__,                     /* baSourceID[bNrInPins] */                    \
    0x00
...
#define AUDIO_AS_DESCRIPTOR_INIT(bInterfaceNumber, bTerminalLink, bNrChannels, bEndpointAddress, wMaxPacketSize, bInterval, ...) \
    ...
    AUDIO_EP_CONTROL_UNDEF,          /* bmAttributes AUDIO_SAMPLING_FREQ_CONTROL */                                      \
