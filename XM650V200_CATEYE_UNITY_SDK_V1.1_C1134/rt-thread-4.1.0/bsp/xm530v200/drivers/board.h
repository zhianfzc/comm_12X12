 ...
 * Change Logs:
 * Date           Author       Notes
 * 2017-01-20     hgq      the first verion
 */
...
#define HEAP_END        (void*)(0x80D00000)  //TODO
...
#define gpio_write(x, y) writel((x), XM_GPIO_BASE + (y) * 4)
#define gpio_read(y) readl(XM_GPIO_BASE + (y) * 4)
